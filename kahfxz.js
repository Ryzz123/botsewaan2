...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c53351d43fdd3c3f6db97.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n *Bot Rental Prices*\n• 13k Per Group via E-Walet 1 Month\n• 18k via pulsa 1 Month\n\n *Premium Price Bot*\n• 10k per User 1 bulan\n\nPayment *can be via //gopay*\n\nmore details, you can chat with the owner\nhttps://wa.me/6285163627306 (Owner)` }, { quoted: m })
            }
            break
            case 'sc': {
...
break
            case 'list': case 'menu': case 'help': case '?': {
            	pref = 1
            	m.reply('Mau Sewa bot? Pc Wa.me/6285163627306!!!')
                anu = `
┌───❑ *Bot Info* ❑──      
│🖥️LibrayLibray : *Baileys Multi Device*
│🤖Name Bot : *ArltShop_0*
│👤Creator : *RyzzBotz*
│☠️AuthorAuthor : *ArltShop_0*
...
`, "ArltShop_0", " L I S T ",  sectionnya, { quoted: m})
break
case 'grupmenu': {
	            anu = `
┌───❑ *Group Menu*
...
╰─────────❑ 
  `
  textTemplateButtons(m.chat, anu, `ArltShop`, btn)
            }
break
case 'downloadmenu': {
	anu = `
...
`, "ArltShop_0", " O R D E R ",  sectionn, { quoted: m})
break
